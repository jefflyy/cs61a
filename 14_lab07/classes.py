...
class AICard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        opponent_card.attack = max(opponent_card.attack - opponent_card.defense, 0)
...
class TutorCard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        True
        """
        opponent.hand = opponent.hand[3:] + [opponent.draw() for i in range(3)]
...
class InstructorCard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        s_deck=player.deck.cards
        for i in range(len(s_deck)):
            s_deck[i].attack += opponent_card.attack
            s_deck[i].defense += opponent_card.defense
        opponent.deck.cards = list(filter(lambda x:not(x.attack == opponent_card.attack or x.defense == opponent_card.defense),opponent.deck.cards))
        # You should add your implementation above this.
